...
// Look for the end of the Challenge section block
...
if (startIndex !== -1 && endIndex !== -1) {
  const inlineReplacement = `
                    ...
                    {(() => {
                      const todayInfo = challengeData.days.find(d => d.status === 'today') || challengeData.days.find(d => d.day === challengeData.currentDay);
